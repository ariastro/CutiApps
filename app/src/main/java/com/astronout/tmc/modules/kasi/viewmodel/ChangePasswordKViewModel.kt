...
class ChangePasswordKViewModel(application: Application): AndroidViewModel(application) {
    ...
    fun changePassword() {
        ...
        remoteRepository.postChangePasswordKasi(oldPassword.value!!, newPassword.value!!, User.kasiId, {
