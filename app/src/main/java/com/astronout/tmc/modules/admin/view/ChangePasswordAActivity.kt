...
import com.astronout.tmc.databinding.ActivityChangePasswordABinding
import com.astronout.tmc.modules.admin.viewmodel.ChangePasswordAViewModel
import com.astronout.tmc.utils.Constants
import com.astronout.tmc.utils.showToast

class ChangePasswordAActivity : BaseActivity() {

    private lateinit var binding: ActivityChangePasswordABinding
    private lateinit var viewModel: ChangePasswordAViewModel

    companion object {
        const val REQUEST_CHANGE_PASSWORD = 421
    }

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding = DataBindingUtil.setContentView(this, R.layout.activity_change_password_a)
        viewModel = ViewModelProvider(this).get(ChangePasswordAViewModel::class.java)
        binding.changePasswordAdmin = viewModel
