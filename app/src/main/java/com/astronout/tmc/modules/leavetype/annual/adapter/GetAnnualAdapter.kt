package com.astronout.tmc.modules.leavetype.annual.adapter
...
class GetAnnualAdapter(private val onClickListener: OnClickListener): ListAdapter<GetAnnualModel, GetAnnualAdapter.GetAnnualViewHolder>(DiffCallback){
