...
class ChangePasswordAViewModel(application: Application): AndroidViewModel(application) {
    ...
    fun changePassword() {
        ...
        remoteRepository.postChangePasswordAdmin(oldPassword.value!!, newPassword.value!!, User.adminId, {
