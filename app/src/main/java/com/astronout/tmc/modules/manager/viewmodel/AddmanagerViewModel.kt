...
class AddmanagerViewModel(application: Application): AndroidViewModel(application) {
    ...
    fun addManager() {
        ...
        remoteRepository.postNewManager(username.value!!, password.value!!, name.value!!,
